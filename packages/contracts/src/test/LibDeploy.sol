...
library LibDeploy {
  function deploy(
    ...
    if (!_reuseComponents) {
      ...
      console.log("Deploying UpgradeComponent");
      comp = new UpgradeComponent(address(result.world));
      console.log(address(comp));
      ...
      console.log("Deploying CurrentGameComponent");
      comp = new CurrentGameComponent(address(result.world));
      console.log(address(comp));

      console.log("Deploying PriceComponent");
      comp = new PriceComponent(address(result.world));
      console.log(address(comp));

      console.log("Deploying OwnerOfComponent");
      comp = new OwnerOfComponent(address(result.world));
      console.log(address(comp));
    }
  ...
  function deploySystems(address _world, bool init) internal {
    ...
    console.log("Deploying CreateGameSystem");
    system = new CreateGameSystem(world, address(components));
    world.registerSystem(address(system), CreateGameSystemID);
    ...
    authorizeWriter(components, UpgradeComponentID, address(system));
    ...
    authorizeWriter(components, PriceComponentID, address(system));
    authorizeWriter(components, OwnerOfComponentID, address(system));
    console.log(address(system));

    console.log("Deploying PurchaseShipSystem");
    system = new PurchaseShipSystem(world, address(components));
    world.registerSystem(address(system), PurchaseShipSystemID);
    authorizeWriter(components, PositionComponentID, address(system));
    authorizeWriter(components, RotationComponentID, address(system));
    authorizeWriter(components, MoveCardComponentID, address(system));
    authorizeWriter(components, LengthComponentID, address(system));
    ...
    console.log("Deploying ExtractShipSystem");
    system = new ExtractShipSystem(world, address(components));
    world.registerSystem(address(system), ExtractShipSystemID);
    authorizeWriter(components, PositionComponentID, address(system));
    authorizeWriter(components, RotationComponentID, address(system));
    authorizeWriter(components, MoveCardComponentID, address(system));
    authorizeWriter(components, LengthComponentID, address(system));
    ...
    console.log("Deploying SpawnPlayerSystem");
    system = new SpawnPlayerSystem(world, address(components));
    world.registerSystem(address(system), SpawnPlayerSystemID);
    authorizeWriter(components, PositionComponentID, address(system));
    authorizeWriter(components, RotationComponentID, address(system));
    authorizeWriter(components, MoveCardComponentID, address(system));
    authorizeWriter(components, LengthComponentID, address(system));
